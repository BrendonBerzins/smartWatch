...
export default function Personalise(){
    return(
        <section id='' className='flex flex-col md:flex-row gap-5 w-screen mb-10 justify-center items-center'>
        <div className='bg-[#f5f5f7] h-[100vh] flex flex-col justify-center items-center'> 
